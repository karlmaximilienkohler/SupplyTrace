...
**Pillar 4: Substitutability.** This pillar assesses how readily one could replace a component that has become unavailable. Components that relate to higher levels of specialisation, identified by keywords including "custom", "mixing chamber", "superconducting", "niobium", "nbti", "josephson", "dilution", "helium-3", "he-3", and "tritium", receive a score of 0.8. All other components receive a score of 0.3. (The last three terms were added during preparation of this paper; see Section 4.1 for the specific inconsistency that prompted the correction.)
